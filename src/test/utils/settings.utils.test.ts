...
suite('setting.utils.test', () => {
  suite('getTargetStringTypes', () => {
    ...
    test('should be empty if all targets are set to false', () => {
    ...
    test('should contain "StringType.TEMPLATE_LITERAL" if "convertToBackticks" is set to true', () => {
    ...
    test('should contain "StringType.SINGLE_QUOTE" if "convertToSingleQuotes" is set to true', () => {
    ...
    test('should contain "StringType.DOUBLE_QUOTE" if "convertToDoubleQuotes" is set to true', () => {
    ...
    test('should contain all possibilities if all are set to true', () => {
  ...
  suite('getLanguages', () => {
    ...
    test('should contain "javascript" if set to true', () => {
    ...
    test('should contain "javascriptreact" if set to true', () => {
    ...
    test('should contain "typescript" if set to true', () => {
    ...
    test('should contain "typescriptreact" if set to true', () => {
  ...
  suite('getTargetMessages', () => {
    test('should map the conversion texts correctly', () => {
